...
public class AdminOfficeWorkersDepartment<String> implements Initializable {
    ...
    public void recruitButtonOnAction(ActionEvent e) throws IOException {
        FXMLLoader logInLoader = new FXMLLoader(getClass().getResource("officeWorkerRecruit.fxml"));
    ...
    public void refreshTable(){
        try {
            StaffList.clear();
            String query = (String) "SELECT staff.emp_id,staff.firstName,staff.secondName,staff.gender,role.role,staff.location,staff.date_recruited FROM `staff` JOIN role ON staff.role_nu = role.role_nu WHERE staff.dep_code ='OS15'";
